      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-8">
            ...
            <p>{'Kaveh Akbar’s poems appear recently or soon in '}<em>{'The New Yorker, Poetry, The New York Times, The Nation, Tin House, The Guardian, Ploughshares, FIELD, Georgia Review, PBS NewsHour, Harvard Review, American Poetry Review, Narrative, The Poetry Review, AGNI, New England Review, A Public Space, Prairie Schooner, Virginia Quarterly Review, Poetry International, Best New Poets 2016, Guernica, Boston Review,'}</em> {'and elsewhere. His debut full-length collection, '}<a href="http://alicejamesbooks.org/ajb-titles/calling-a-wolf-a-wolf/" title="Calling A Wolf A Wolf"><em>{'Calling a Wolf a Wolf'}</em></a>, {'is just out with Alice James in the US and Penguin in the UK, and his chapbook, '}<a href="http://siblingrivalrypress.bigcartel.com/product/portrait-of-the-alcoholic-by-kaveh-akbar" title="Portrait of the Alcoholic"><em>{'Portrait of the Alcoholic'}</em></a>{', was published by Sibling Rivalry Press. The recipient of a 2016 Ruth Lilly and Dorothy Sargent Rosenberg Fellowship from the Poetry Foundation, a Pushcart Prize, and the Lucille Medwick Memorial Award from the Poetry Society of America, Kaveh was born in Tehran, Iran, and currently lives and teaches in Florida.'}</p>
