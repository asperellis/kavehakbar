      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4">
            <img src="http://www.alexsperellis.com/kavehakbar/kaveh.jpg" alt="Kaveh Akbar" className="img-fluid" />
          </div>
          <div className="col-md-8">
            ...
            <p><span className="bold">CONTACT</span>: <a href="mailto:kavehakbarpoetry@gmail.com" title="Send an email to Kaveh">kavehakbarpoetry@gmail.com</a> or on Twitter <a href="https://twitter.com/KavehAkbar" title="Follow Kaveh on Twitter">@KavehAkbar</a>.
            <br /><span className="bold">BOOKING</span>: Tabia Yapp, <a href="mailto:t@beotis.com" title="Booking Contact for Kaveh">t@beotis.com</a>
            </p>
