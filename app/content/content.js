...
const books = [{
    ...
    quotes: [{
      ...
      {
        quote: 'Akbar proves what books can do in his exceptional debut, which brings us along on his struggle with addiction, a dangerous comfort and soul-eating monster he addresses boldly.',
        speaker: 'Starred Review',
        publication: 'Library Journal'
      },
      {
        quote: 'Akbar has what every poet needs: the power to make, from emotions that others have felt, memorable language that nobody has assembled before.',
        speaker: 'Steph Burt',
...
const words = {
  online: [{
      ...
      url: 'http://www.newyorker.com/magazine/2017/06/05/what-use-is-knowing-anything-if-no-one-is-around',
      publication: 'The New Yorker'
    },
    {
      title: 'No is a Complete Sentence',
      url: 'http://www.nereview.com/vol-37-no-4-2016/no-is-a-complete-sentence/',
      publication: 'New England Review'
    },
    {
      title: 'Seven Poems',
      url: 'https://www.poetryfoundation.org/poems-and-poets/poets/detail/kaveh-akbar#about',
      publication: 'Poetry'
    },
    {
      title: 'Six Poems',
    ...
    },
    {
      ...
      url: 'https://www.nytimes.com/2017/10/20/magazine/poem-being-in-this-world-makes-me-feel-like-a-time-traveler.html',
      publication: 'The New York Times'
    },
    {
      title: 'Do You Speak Persian?',
      url: 'http://www.narrativemagazine.com/issues/poems-week-2015-2016/poem-week/do-you-speak-persian-kaveh-akbar',
    ...
    {
      title: 'Heritage',
      url: 'https://www.poetrysociety.org/psa/awards/annual/winners/2016/award_9/',
    ...
    {
      title: 'Palmyra',
      url: 'http://www.pbs.org/newshour/poetry/poet-remembers-the-man-who-fought-and-died-to-save-palmyra/',
  ...
  reviews: [{
      ...
      reviews: [{
        ...
        {
          url: 'http://lj.libraryjournal.com/bestbooks2017/poetry_literature.php',
          title: 'STARRED review in ',
          publication: 'Library Journal'
        },
        {
          url: 'https://yalereview.yale.edu/sites/default/files/files/Burt%2CStephen_PoetryinReview_jul2017.pdf',
          title: 'reviewed in ',
          publication: 'The Yale Review'
        },
        {
          url: 'https://pionline.wordpress.com/2017/06/23/working-with-eggshells-a-review-of-kaveh-akbars-calling-a-wolf-a-wolf/',
          title: 'reviewed in ',
          publication: 'Poetry International'
        },
        {
          url: 'http://www.vqronline.org/poetry-criticism/2017/07/toward-new-masculinity',
          title: 'reviewed in ',
          publication: 'Virginia Quarterly Review'
        }
      ]
    },
    {
      title: 'Portrait of the Alcoholic',
      reviews: [{
          url: 'http://blog.bestamericanpoetry.com/the_best_american_poetry/2017/03/alchemical-the-body-becomes-a-mound-of-jewels-an-ancient-hunger-dante-di-stefano-reviews-kaveh-akbar.html',
          title: 'reviewed in ',
          publication: 'Best American Poetry'
        },
        {
          url: 'http://blog.pshares.org/index.php/thirst-trap-desperation-in-kaveh-akbars-portrait-of-the-alcoholic/',
          title: 'reviewed in ',
          publication: 'Ploughshares'
        },
        {
          url: 'https://www.theblueshiftjournal.com/single-post/2017/01/28/Haunted-Reflection-Review-of-Kaveh-Akbar%E2%80%99s-Portrait-of-the-Alcoholic',
          title: 'reviewed in ',
          publication: 'Blueshift Journal'
        },
        {
          url: 'http://www.greenlindenpress.com/interviews-and-reviews/#/kaveh-akbar/',
          title: 'reviewed in ',
  ...
  conversations: [{
      url: 'https://thegeorgiareview.com/online/back-and-forth-with-kaveh-akbar/',
      with: 'The Georgia Review'
    },
    {
      url: 'https://slicemagazine.org/literal-magic-an-interview-with-poet-kaveh-akbar/',
      with: 'Slice'
    },
    {
      url: 'https://www.thefix.com/kaveh-akbar-maps-unprecedented-experience-portrait-alcoholic',
      with: 'The Fix'
    },
    {
      url: 'https://medium.com/drunken-boat/witness-the-hour-conversations-with-arab-american-poets-across-the-diaspora-27591ba7a082',
      with: 'Drunken Boat'
    },
    {
      url: 'http://prairieschooner.unl.edu/blog/kaveh-akbar-illicit-luck-daily-poetry-practice',
    ...
    {
      url: 'http://www.fsunews.com/story/news/2016/01/06/phd-student-isis-victim-poem/78321796/',
      with: 'FSView'
    },
    {
      url: 'http://www.thereviewreview.net/interviews/giving-poets-room-speak-meaningfully-chat-kaveh-a',
  ...
  press: [{
    ...
    },
    {
      ...
      title: 'In ‘Whitman’s Descendents,’ photographing some of America’s greatest living poets',
      publication: 'PBS NewsHour'
    },
    {
    ...
    {
      url: 'http://www.kenyonreview.org/2016/08/orchids-transformative-power-longing/',
      title: 'Orchids We Have Been: On The Transformative Power of Longing',
      publication: 'Kenyon Review'
    },
    {
      url: 'https://www.poetryfoundation.org/harriet/2016/02/prairie-schooner-interviews-kaveh-akbar-man-with-chutzpah/?woo',
    ...
    {
      url: 'https://www.poetryfoundation.org/harriet/2016/01/kaveh-akbar-reads-palmyra-at-pbs-newshour/',
      title: "Kaveh Akbar Reads 'Palmyra' at PBS NewsHour",
      publication: 'Poetry Foundation'
    },
    {
      url: 'http://www.thereviewreview.net/reviews/new-journal-dedicates-itself-interviews-poets',
      title: 'New Journal Devotes Itself to Interviews with Poets',
      publication: 'The Review Review'
    },
    {
      url: 'https://www.poetryfoundation.org/harriet/2015/07/go-ahead-and-speak-meaningfully-with-divedapper/',
      title: 'Go Ahead and Speak Meaningfully With Divedapper',
      publication: 'Poetry Foundation'
    },
    {
      url: 'https://www.nytimes.com/2015/07/26/books/review/an-unfinished-library.html?_r=1',
      title: 'in',
      publication: 'The New York Times'
    },
    {
      url: 'https://www.bostonglobe.com/metro/2015/05/15/franz-wright-waltham-pulitzer-prize-winning-poet-dies/kkYxHZXge3tsxS87EmDx4O/story.html',
      title: 'in',
      publication: 'The Boston Globe'
    },
    {
      url: 'http://therumpus.net/2014/09/divedapper-focuses-on-poet-interviews/',
