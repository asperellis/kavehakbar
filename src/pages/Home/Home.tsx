        ...
        <article className="book">
          <div className="row">
            ...
            <div className="col-md-8 col-text">
              ...
              <BuyButton
                links={martyr.urls}
                title={`Order ${martyr.title} Online`}
              />
            </div>
          </div>
        </article>
          ...
          <div className="row">
            <div className="col-md-8 col-text">
              ...
              <div className="row">
                <div className="col-lg-6">
                  <p>
                    &ldquo;<em>Pilgrim Bell</em> is bracing in its honesty and
                    noteworthy in its steadfast adherence to finding the
                    spiritual in even the most mundane settings. Akbar's
                    mesmerizing dexterity with language is at its most
                    compelling when he is relentlessly pursuing the truth―a hunt
                    that’s present in every poem in this volume.&rdquo;
                    <br />—
                    <strong>
                      <em>TIME</em>
                    </strong>
                  ...
                  <p>
                    &ldquo;Akbar is exquisitely sensitive to how language can
                    function as both presence and absence. . . . His practice of
                    taking language apart, and harnessing the empty space around
                    it, makes even the most familiar words seem eerie and
                    unexpected.&rdquo;
                    <br />—
                    <strong>
                ...
                <div className="col-lg-6">
                  <p>
                    &ldquo;Working at and along the outer edges of language,{" "}
                    <em>Pilgrim Bell</em> calls us to attention and to attend to
                    that which poetry and prayer share.&rdquo;
                    <br />—<strong>M. NourbeSe Philip</strong>
                  </p>
                  <p>
                    &ldquo;Profound and singular, smart and sad and funny, but
                    most of all truth's beauty and beauty's truth sung... We
                    need <em>Pilgrim Bell</em>. We need Kaveh Akbar.&rdquo;
                    <br />—<strong>Tommy Orange</strong>
                  </p>
                  <p>
                    &ldquo;<em>Pilgrim Bell</em> is destined to become a
                    classic, another blazing torch added to the eternal
                    flames.&rdquo;
                    <br />—<strong>Mary Karr</strong>
                  </p>
                  <p>
                    &ldquo;<em>Pilgrim Bell</em> is a book that chooses honesty
                    over beauty, which makes it a breathtaking text&rdquo;
                    <br />—<strong>Hanif Abdurraqib</strong>
                  </p>
                </div>
              </div>
              <BuyButton
                links={pilgrimBell.urls}
                preorder={pilgrimBell.preorder}
          ...
          <div className="row">
            ...
            <div className="col-md-8 col-text">
              ...
              <div className="row">
                <div className="col-lg-6">
                  <p>
                    &ldquo;An outstanding book of poetry... unknowable and
                    always beautiful&rdquo;
                    <br />—<strong>Roxane Gay</strong>
                  </p>
                  <p>
                    &ldquo;This is bounty, an intensely inventive and original
                    debut.&rdquo;
                    <br />—<strong>Frank Bidart</strong>
                  </p>
                  <p>
                    &ldquo;Truly brilliant.&rdquo;
                    <br />—<strong>John Green</strong>
                  </p>
                  <p>
                    &ldquo;Akbar has what every poet needs: the power to make,
                    from emotions others have felt, memorable language nobody
                    has assembled before.&rdquo;
                    <br />—
                    <strong>
                      Stephanie Burt, <em>Yale Review</em>
                    </strong>
                  </p>
                </div>
                <div className="col-lg-6">
                  <p>
                    &ldquo;A bright flash of lightning illuminating the
                    landscape of craving.&rdquo;
                    <br />
                    <strong>
                      Leslie Jamison, <em>The Guardian</em>
                    </strong>
                  </p>
                  <p>
                  ...
                  <p>
                    &ldquo;A breathtaking addition to the canon of addiction
                    literature.&rdquo;
                    <br />—
                    <strong>
          ...
          <div className="row">
            <div className="col-md-8 col-text">
              ...
              <div className="row">
                <div className="col-lg-6">
                  <p>
                    &ldquo;A profoundly valuable (and finely produced)
                    collection, full of fresh perspective, and opening doors
                    into all kinds of material that has been routinely neglected
                    or patronized. Akbar's deeply personal framing of such a
                  ...
                  <p>
                    &ldquo;A delightful celebration of human creativity, with
                    new insights from a trusted guide: Kaveh Akbar.&rdquo;
                    <br />—<strong>Chine McDonald</strong>
                  </p>
                </div>
                <div className="col-lg-6">
                  <p>
                    &ldquo;There cannot be any other anthology that ranges so
                    widely.&rdquo;
                    <br />—<strong>John Barton</strong>
                  </p>
                  <p>
                    &ldquo;The chorus of voices gathered offer a balm, a
                    consolation, a tune, in our desolate world.&rdquo;
                    <br />—<strong>Ilya Kaminsky</strong>
                  </p>
                  <p>
                    &ldquo;Vibrating across this thick bundle of verse is the
                    animation of the spirit enmeshed with the body, astounding
                    in its ever-shifting forms, its irrepressible music.&rdquo;
                    <br />—<strong>Jenny Xie</strong>
                  </p>
                </div>
              </div>
              <BuyButton
                links={spiritualVerse.urls}
