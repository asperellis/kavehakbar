      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4">
            <blockquote>
              &ldquo;Akbar is exquisitely sensitive to how language can function
              as both presence and absence.&rdquo;
              <br />
            ...
            <div>
              {words.prose.map((prose, i) => (
                <div className="poem" key={`prose${i}`}>
                  <a
                    href={prose.url}
                    title={`Read ${prose.title}`}
                    key={`prose${i}`}
                  >
                    {prose.title}
                  </a>
                  {typeof prose.publication === "string" ? (
                    <em>
                      , <br className="poem-line-break" />
                      {prose.publication}
                    </em>
              ...
              <p key={`reviews${i}`}>
                ...
                {book.reviews.map((review, index) => {
                  return (
                    ...
                    >
                      {review.title}
                      {typeof review.publication === "string" ? (
